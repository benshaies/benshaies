...
## 👤 About Me
- ⚙️ I build games in C
- 🖥️ Self-hosting hobbyist
- 📦 Published games on [itch.io](https://stillbenja.itch.io) and open source on GitHub
- 📡 Studying CompTIA A+ and growing into IT infrastructure
...
Latest finished game. Available for free on [itch.io](https://stillbenja.itch.io/recall-grounds). v1.0 download also available under releases.

#### [MotionZero](https://github.com/benshaies/MotionZero)
A complete game released on [itch.io](https://stillbenja.itch.io/motion-zero). Available under releases alongside all playtest builds.

#### [SlimeWood Hunter](https://github.com/benshaies/SlimeWood-Hunter)
A Prairie King-inspired top-down arcade shooter. Fast-paced, wave-based.

#### [SquareDash](https://github.com/benshaies/SquareDash)
A Geometry Dash-style rhythm platformer. Obstacles, timing, and momentum.
